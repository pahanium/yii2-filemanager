...
```
php composer.phar require --prefer-dist pahanium/yii2-filemanager "*"
```

or add

```
"pahanium/yii2-filemanager": "*"
```
...
Apply migration
```sh
yii migrate --migrationPath=vendor/pahanium/yii2-filemanager/migrations
```
...
'modules' => [
    'filemanager' => [
        'class' => 'pahanium\filemanager\Module',
        // Upload routes
        'routes' => [
...
```php
use pahanium\filemanager\widgets\FileInput;
...
With TinyMCE:
```php
use pahanium\filemanager\widgets\TinyMCE;
...
```php
use pahanium\filemanager\behaviors\MediafileBehavior;
...
```php
use pahanium\filemanager\models\Mediafile;
