<?php
namespace pahanium\filemanager\widgets;
 ...
 * More samples of usage see on github: https://github.com/pahanium/yii2-filemanager
 *
 * @package pahanium\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/pahanium/yii2-filemanager/views/file/modal.php', [
